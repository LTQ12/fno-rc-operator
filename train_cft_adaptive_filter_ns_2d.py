...
CFT-Adaptive Filter Fourier Neural Operator for 2D Navier-Stokes.
"""
import torch
import numpy as np
...
# Import the final model definition and utilities
from fourier_2d_cft_adaptive_filter import FNO_CFT_AdaptiveFilter
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train CFT-Adaptive Filter FNO.')
    
    parser.add_argument('--data_path', type=str, default='/content/drive/MyDrive/ns_data_N600_clean.pt', help='Path to data file.')
    parser.add_argument('--model_save_path', type=str, default='models/cft_adaptive_filter_fno.pt', help='Path to save the trained model.')
