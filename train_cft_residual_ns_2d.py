"""
Trainer for the FNO with CFT-based Residual Correction (FNO-RC).
This is the final proposed architecture based on residual correction principles.
"""
import torch
import numpy as np
...
def main(args):
    ...
    print(f"\nModel: FNO with CFT-based Residual Correction (FNO-RC)")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Train FNO-RC.')
    
    parser.add_argument('--data_path', type=str, default='/content/drive/MyDrive/ns_data_N600_clean.pt', help='Path to data file.')
    parser.add_argument('--model_save_path', type=str, default='models/fno_rc.pt', help='Path to save the trained model.')
